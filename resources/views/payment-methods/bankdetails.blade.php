        ...
        <div class="modal-body">
            <form action="{{ route('Bankdetails.update') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$select->bank_name}}" placeholder="Name" name="bank_name">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" value="{{$select->account_name}}" placeholder="Account Name" name="account_name">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" value="{{$select->account_number}}" placeholder="Account Number" name="account_number">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" value="{{$select->bsb}}" placeholder="BSB" name="bsb">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" value="{{$select->country}}" placeholder="Country" name="country">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" value="{{$select->account_currency}}" placeholder="Account Currency" name="account_currency">
                </div>
