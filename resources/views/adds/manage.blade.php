...
<div class="row justify-content-center align-items-center m-0" id="register">
    <div class="col-md-8 form px-5 pt-3 active shadow-lg">
        ...
        <div class="col-12 d-flex justify-content-between">
            <h3 class="text-primary d-none d-lg-block" style="color: ">Advertisements</h3>
            @isset($select)
        ...
        <table class="table table-bordered ">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    @endif</td>
                    <td>
                        <a href="{{ route('adds.selectspecific', ['id'=>$item->id]) }}" class="btn btn-outline-primary btn-sm"><i class="far fa-eye"></i></a>
