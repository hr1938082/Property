...
<div class="width-100">
    <div class="width-300">
        <form enctype="multipart/form-data" action="{{ route('adds.store') }}" id="property" class="w-100 d-flex mt-2" method="post">
            @csrf
            <div class="wrapper fadeInDown align-items-center" style="height: 100vh">
                <div id="formContent">
                    ...
                    <div class="form-group">
                        <div class="form-inline justify-content-center">
                                <select class="fadeIn third px-1" style="width: 120px" name="currency_id" id="currency_id">
                                    <option selected disabled>Currency</option>
                                    @foreach ($currency as $curr)
                                        <option value="{{$curr->id}}">{{$curr->currency}}</option>
                                    @endforeach
                                </select>
                                <input id="Rent" type="text" class="fadeIn third px-1" style="width: 120px" name="rent" placeholder="Price"
                                    autocomplete="none">
                                <select class="fadeIn third px-1" style="width: 120px" name="for" id="for_id">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group">
                                ...
                                <div class="form-inline">
                                    <select class="fadeIn third px-1 rounded-0 m-0" style="width: 75px" name="build_date" id="build_date"
            ...
            <div class="wrapper fadeInDown align-items-center" style="height: 100vh">
                <div id="formContent">
                    ...
                    <div class="form-group">
                        <div class="form-inline justify-content-center">
                            <input id="street" type="text" placeholder="Street" name="street" autocomplete="none"  style="width: 185px">
                            <input id="zipcode" type="text" placeholder="Zip code" name="zip_code" autocomplete="none"  style="width: 185px">
                        </div>
                    ...
                    <div class="form-group">
                        <input id="owner_name" type="text" placeholder="Name" name="owner_name" autocomplete="none">
                        <div class="text-danger" id="owner_name-span"></div>
                    </div>
                    <div class="form-group">
                        <input id="owner_email" type="text" placeholder="Email" name="owner_email" autocomplete="none">
                        <div class="text-danger" id="owner_email-span"></div>
                    </div>
                    <div class="form-group">
                        <input id="owner_phone" type="text" placeholder="Phone" name="owner_phone" autocomplete="none">
    ...
    $(document).ready(() => {
        ...
        $('#second').click(() => {
            if ($('#country-input').val() == "") {
                ...
                $('#street-span').text("Zipcode is Required!!")
                ...
                $('#street-span').text("")
                $('#zipcode').css('border', '1px solid red');
                $('#street-span').text("Only Numbers are allowed!!")
