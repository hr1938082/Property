...
class PropertyRequestController extends Controller
{
    ...
    {
        $select = PropertyRequest::select('preperty_request.id','preperty_request.tendent_id','users.name',
        'users.email','properties.id as property_id','properties.property_name')
